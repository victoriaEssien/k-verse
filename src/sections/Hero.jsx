    ...
    <section className="mx-4 md:mx-14">
        ...
        <div className="flex flex-col md:flex-row">
            ...
            <div className=''>
                ...
                <Link to="">
                  <button type='button' className='bg-[#2E7D32] rounded-md text-center block md:inline font-lato text-white text-lg font-normal w-full md:w-fit px-7 py-3.5 hover:bg-primary-800'>Get started!</button>
                </Link>
                {/* <Link to='/login'>
